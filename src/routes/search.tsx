    ...
    <section className="bg-cream min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          {isLoading ? (
            // Skeleton Loader
            <div className="grid grid-cols-1 sm:grid-cols-2 min-[990px]:grid-cols-4 gap-[10px] min-[750px]:gap-[20px]">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 min-[990px]:grid-cols-4 gap-[10px] min-[750px]:gap-[20px] animate-fade-in">
                {products.map((p) => {
