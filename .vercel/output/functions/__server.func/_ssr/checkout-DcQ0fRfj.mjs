...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/checkout-BDBgADf7.mjs
import { u as useCart, g as getUserActiveOrderStatus, b as createOrder } from "./router-D98JWfRI.mjs";
========
import { u as useCart, g as getUserActiveOrderStatus, b as createOrder } from "./router-CN-wybRF.mjs";
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/checkout-DcQ0fRfj.mjs
...
function CheckoutPage() {
  ...
  if (checkingAuth) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[var(--card)] p-12 shadow-soft flex flex-col items-center justify-center min-h-[300px]", children: [
  ...
  if (authError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[var(--card)] p-12 shadow-soft space-y-4", children: [
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[var(--card)] p-12 shadow-soft space-y-6", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1.4fr_0.9fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 rounded-3xl bg-[var(--card)] p-8 shadow-soft", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: handleSubmit, disabled: mutation.isPending, className: "inline-flex w-full items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-soft hover:bg-primary/90 disabled:opacity-50", children: mutation.isPending ? "Placing order..." : "Place order" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6 rounded-3xl bg-[var(--card)] p-6 shadow-soft", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[var(--background)] p-5 text-sm text-[var(--foreground)]/80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Checkout stays in PHP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2", children: "All charges are settled in Philippine Peso. Previewed conversions are estimates only." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[var(--background)] p-5 text-sm text-[var(--foreground)]/80", children: [
