...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BZHe_Hv9.mjs");
...
const manifest = {
  "017f11955e2825eee78e335e200cda245acf509074047ecd2de46db831030dc6": {
    ...
    importer: () => import("./supabase.functions-ITyD9o90.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BWI5fU0i.mjs").then((n) => n.B),
    import("./start-C1jrWHio.mjs"),
