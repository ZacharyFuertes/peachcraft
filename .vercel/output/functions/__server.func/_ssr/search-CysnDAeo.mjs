...
import { R as Route$h, a as searchProducts } from "./router-C4B3aEDs.mjs";
import "../_libs/seroval.mjs";
import { h as ArrowLeft, S as Search, P as Package, b as Sparkles } from "../_libs/lucide-react.mjs";
...
function SearchResultsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12", children: isLoading ? (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in", children: products.map((p) => {
