...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/server-BWmwJzJ_.mjs
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DsiBDz_K.mjs");
========
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DKs_yciI.mjs");
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/server-BO7pyA8t.mjs
...
const manifest = {
  "017f11955e2825eee78e335e200cda245acf509074047ecd2de46db831030dc6": {
    functionName: "getProductById_createServerFn_handler",
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/server-BWmwJzJ_.mjs
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "134239e0b57c1a0828a2ca1b12c707e0765b30e82fd974e9fbdcd6921e300fee": {
    functionName: "getAllProducts_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "18ed727622b898cf89c5c033b5a38eda1bf0aa8e890c7960beff86b493fae0ab": {
    functionName: "getAutocompleteSuggestions_createServerFn_handler",
    importer: () => import("./search.functions-CIH29_qF.mjs")
  },
  "2096d130a286e3dfec5d2a1f28242a67bcb36445b791d215188e546a5f85f4ef": {
    functionName: "uploadStoreImage_createServerFn_handler",
    importer: () => import("./storeDetails.functions-DPHLezPT.mjs")
  },
  "21a18b21d98c300eac8679b420612d35df84a11ab4e477bcace47f48a53c37f3": {
    functionName: "updateProduct_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "2e52d376c560f13f4b61f22e7cd08cf944cdef0b00910a15331f3822d10cd61a": {
    functionName: "getFeaturedProducts_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "2f977311003aaad1bedfed02a9a50a1a411aca285b5b2ba2291f02325dc05b7b": {
    functionName: "getCartForUser_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "3960bcf3f9a6a8d577539bac29a414e1e2d282f328e75b24a2c489df6eb9eada": {
    functionName: "checkEmailVerification_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "3cdebb12d1443d2c3ae4db1b9e7ebcb404efad457c7ca9fc5851130d258158ee": {
    functionName: "getOrdersList_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "3da541399998645662eb6354918334f237760cff00d444ed65abbc1f10fa8a46": {
    functionName: "searchProducts_createServerFn_handler",
    importer: () => import("./search.functions-CIH29_qF.mjs")
  },
  "4da3201e5791e31c4e6845e165471eb6c3e365aef4d8e13c598cdea140c6c944": {
    functionName: "getOrderDetails_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "50dc331cd0a5f6cb1e5012163c717012557d8aeb981e34426223f7a36bc7efff": {
    functionName: "signUpWithProfile_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "59a79d6f704facff26f36b652cb66d2fff0e4b7a343a79c87ae3c4938fd08949": {
    functionName: "updateStoreDetails_createServerFn_handler",
    importer: () => import("./storeDetails.functions-DPHLezPT.mjs")
  },
  "5a3ea73e22e890dc236f252494d16759d214434f052b691d398bf6ff371fc934": {
    functionName: "getAdminProducts_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "6c3526fdbf4f16975cc94b6c49ced8acc7a2debaeeca6c8d4523fa938ec4ba7e": {
    functionName: "updateOrderStatus_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "724b4a807909a6cb3bf92641c31b4ddf645e7527d63be7206083cc9bfa163f57": {
    functionName: "createOrder_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "7e76ff5110a5d02668819d1c037a172495db3e431fc0529ab9c1194ef657affc": {
    functionName: "getAdminDashboardData_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "836924c59abf2bce45bbb63fb90bd96e3b2a39526f9ce59b9886c6fd17be7421": {
    functionName: "uploadProductImage_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "91ca8d8ff077a706d74f7f830e2c09f280b97623aa37e44fa17a05d56e4f8d7b": {
    functionName: "verifyEmail_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "9a027eb7fe617841ed2e12c0f59efc52bd6fa86ced99b71b0d562e7c0eb3bf33": {
    functionName: "createProduct_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "a799c956eef1866ba8ef6cd4fb4954e8c3cbce8c7fd51a850e82dd1566a9f011": {
    functionName: "getMyOrders_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "b11adab6bbee01ffbf09d77542fd6ddb6ca14d4b02f5961a5d5cef7fcb9d1263": {
    functionName: "getUserActiveOrderStatus_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "b6fc71d242071d137840a72f04ba960c612aa824c43b4cfe38cfc23bbd85efa6": {
    functionName: "getDashboardData_createServerFn_handler",
    importer: () => import("./dashboard.functions-ByCsk5D4.mjs")
  },
  "c1efde8f7b62c99682bf334c4daacec2d017d9c10b92c7930bc2a47e0e0848ac": {
    functionName: "getStoreDetails_createServerFn_handler",
    importer: () => import("./storeDetails.functions-DPHLezPT.mjs")
  },
  "c2bfc448f09020514abc1480a33033370d741a5a2ec42cd15bbe751f456a3211": {
    functionName: "toggleProductActive_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "c450a30d31a564973c85e65058f78677a15e5238e844cd31e6770b5f4af09e99": {
    functionName: "getAnalyticsData_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "ca0384b788bbc6e7f55d89600f226bb491b2c710240621167497ef736537cb7b": {
    functionName: "saveCartForUser_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "d3249ff7c53baf1d5aa77d833043dc591a1089c14640644703529aa10b895a58": {
    functionName: "deleteProduct_createServerFn_handler",
    importer: () => import("./supabase.functions-BcRPIoPM.mjs")
  },
  "fb1703cba41559b52c54b6b3eef2ea4d30b220b4e655707cba1496dfbfebb3b7": {
    functionName: "getCustomers_createServerFn_handler",
    importer: () => import("./customers.functions-By0MhU_z.mjs")
========
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "0453a1ae017fbcd8fef461d849f5b4c65a7a0fcbc3b1fa9fa66f3ba190972412": {
    functionName: "clearCartItems_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "060fd1260430d1bedebd75221fd0964bbc2416b8a47b0a8bca880fe07a23cbb4": {
    functionName: "getCartItemsForUser_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "134239e0b57c1a0828a2ca1b12c707e0765b30e82fd974e9fbdcd6921e300fee": {
    functionName: "getAllProducts_createServerFn_handler",
  ...
  "18ed727622b898cf89c5c033b5a38eda1bf0aa8e890c7960beff86b493fae0ab": {
    functionName: "getAutocompleteSuggestions_createServerFn_handler",
    importer: () => import("./search.functions-CVnzisv8.mjs")
  },
  "2096d130a286e3dfec5d2a1f28242a67bcb36445b791d215188e546a5f85f4ef": {
    functionName: "uploadStoreImage_createServerFn_handler",
    importer: () => import("./storeDetails.functions-B796gMr_.mjs")
  },
  "21a18b21d98c300eac8679b420612d35df84a11ab4e477bcace47f48a53c37f3": {
    functionName: "updateProduct_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  ...
  "3406ed42c59c6b1aa56fe405aaadacbd8a40b098afac711d3767ee91c13f40ba": {
    functionName: "addCartItem_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "3960bcf3f9a6a8d577539bac29a414e1e2d282f328e75b24a2c489df6eb9eada": {
    functionName: "checkEmailVerification_createServerFn_handler",
  ...
  "69efe05081d4c59034791f04c4374641d8f0ada3688fcf7429822492fb114517": {
  ...
  "b65d83cf58c78f7bf88970253e57e99580dc06b18a792f3cba7dc301921419ca": {
    functionName: "mergeCartItems_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "b6fc71d242071d137840a72f04ba960c612aa824c43b4cfe38cfc23bbd85efa6": {
    functionName: "getDashboardData_createServerFn_handler",
    importer: () => import("./dashboard.functions-BAIcqIwp.mjs")
  },
  "c1efde8f7b62c99682bf334c4daacec2d017d9c10b92c7930bc2a47e0e0848ac": {
    functionName: "getStoreDetails_createServerFn_handler",
    importer: () => import("./storeDetails.functions-B796gMr_.mjs")
  ...
  "e3478fa95d3da7fe79645881b2dab62371fae9f35071d51c86095d9e0df9bd42": {
    functionName: "updateCartItemQuantity_createServerFn_handler",
    importer: () => import("./supabase.functions-Cho4QM9L.mjs")
  },
  "fb1703cba41559b52c54b6b3eef2ea4d30b220b4e655707cba1496dfbfebb3b7": {
    functionName: "getCustomers_createServerFn_handler",
    importer: () => import("./customers.functions-Dy79k9p6.mjs")
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/server-BO7pyA8t.mjs
  }
};
...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/server-BWmwJzJ_.mjs
    import("./router-D98JWfRI.mjs").then((n) => n.M),
    import("./start-DIYCV-9Z.mjs"),
========
    import("./router-CN-wybRF.mjs").then((n) => n.O),
    import("./start-CDKvI_At.mjs"),
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/server-BO7pyA8t.mjs
