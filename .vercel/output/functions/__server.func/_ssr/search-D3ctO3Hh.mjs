...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/search-Bn7AZTDe.mjs
import { P as ProductCard } from "./ProductCard-BkC9izPm.mjs";
import { R as Route$k, a as searchProducts } from "./router-D98JWfRI.mjs";
========
import { P as ProductCard } from "./ProductCard-Cnf6dDld.mjs";
import { R as Route$k, a as searchProducts } from "./router-CN-wybRF.mjs";
import { P as PRODUCT_CATEGORY_OPTIONS } from "./productCategories-DYShMXc1.mjs";
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/search-D3ctO3Hh.mjs
import "../_libs/seroval.mjs";
import { p as ArrowLeft, S as Search, P as Package, d as Sparkles } from "../_libs/lucide-react.mjs";
...
function SearchResultsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12", children: isLoading ? (
      // Skeleton Loader
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4", children: Array.from({
        length: 4
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-3xl p-12 text-center shadow-card max-w-2xl mx-auto space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-border space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: PRODUCT_CATEGORY_OPTIONS.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/search", search: {
            q: cat
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 animate-fade-in", children: products.map((p) => {
