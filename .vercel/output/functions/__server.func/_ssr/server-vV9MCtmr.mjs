...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CqZi5_hv.mjs");
...
const manifest = {
  "017f11955e2825eee78e335e200cda245acf509074047ecd2de46db831030dc6": {
    ...
    importer: () => import("./supabase.functions-BvWB9SHq.mjs")
  },
  ...
  "b6fc71d242071d137840a72f04ba960c612aa824c43b4cfe38cfc23bbd85efa6": {
    ...
    importer: () => import("./dashboard.functions-pY0CwvxO.mjs")
  },
  ...
  "fb1703cba41559b52c54b6b3eef2ea4d30b220b4e655707cba1496dfbfebb3b7": {
    ...
    importer: () => import("./customers.functions-CW1R5kEy.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CEXJ6wrN.mjs").then((n) => n.M),
    import("./start-DlwnSTxH.mjs"),
