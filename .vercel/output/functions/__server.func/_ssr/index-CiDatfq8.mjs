...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/index-Beq-zfjT.mjs
import { P as ProductCard } from "./ProductCard-BkC9izPm.mjs";
import { e as getAllProducts } from "./router-D98JWfRI.mjs";
========
import { P as ProductCard } from "./ProductCard-Cnf6dDld.mjs";
import { e as getAllProducts } from "./router-CN-wybRF.mjs";
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/index-CiDatfq8.mjs
...
function ShopPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-10 sm:py-20 min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "mb-8 sm:mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-brown font-bold tracking-tight", children: "Products" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 sm:mt-16 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4", children: isLoading ? Array.from({
      length: 8
