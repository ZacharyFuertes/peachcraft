...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BUDCkLCs.mjs");
...
const manifest = {
  "017f11955e2825eee78e335e200cda245acf509074047ecd2de46db831030dc6": {
    ...
    importer: () => import("./supabase.functions-DoC-UZKV.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C4B3aEDs.mjs").then((n) => n.H),
    import("./start-vAifRzie.mjs"),
