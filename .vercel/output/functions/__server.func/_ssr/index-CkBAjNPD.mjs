...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/index-CDwNYhZJ.mjs
import { h as cn, z as getOrdersList } from "./router-D98JWfRI.mjs";
========
import { h as cn, E as getOrdersList } from "./router-CN-wybRF.mjs";
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/index-CkBAjNPD.mjs
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", children: Array.from({
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredOrders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-[var(--border)]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin/orders/$id", params: {
          id: order.id
        }, className: "inline-flex rounded-full bg-[var(--background)] px-3 py-2 text-xs font-semibold text-[var(--foreground)] shadow-soft hover:bg-[var(--foreground)]/10", children: "View" }) })
      ] }, order.id)) })
    ] }) })
  ] });
}
