...
function PolicyPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-cream py-20 min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
