...
<<<<<<<< HEAD:.vercel/output/functions/__server.func/_ssr/index-BQWYoh2b.mjs
import { P as ProductCard } from "./ProductCard-BkC9izPm.mjs";
import { d as getFeaturedProducts } from "./router-D98JWfRI.mjs";
========
import { P as ProductCard } from "./ProductCard-Cnf6dDld.mjs";
import { d as getFeaturedProducts } from "./router-CN-wybRF.mjs";
>>>>>>>> 8e9d1c4d806b4680033fc485fbb81fd36eb1433e:.vercel/output/functions/__server.func/_ssr/index-AClNmlsj.mjs
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-accent py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4", children: isLoading ? Array.from({
          length: 4
