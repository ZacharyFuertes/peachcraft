...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CtaR_3ZP.mjs");
...
const manifest = {
  "017f11955e2825eee78e335e200cda245acf509074047ecd2de46db831030dc6": {
    ...
    importer: () => import("./supabase.functions-DWfY79eG.mjs")
  },
  ...
  "2096d130a286e3dfec5d2a1f28242a67bcb36445b791d215188e546a5f85f4ef": {
    ...
    importer: () => import("./storeDetails.functions-IkduvS7S.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ChcEy1hy.mjs").then((n) => n.z),
    import("./start-CxD8eKtW.mjs"),
