...
import { i as Route$a, u as useCart, k as useCartToast, h as cn, j as getProductById, e as getAllProducts } from "./_ssr/router-CEXJ6wrN.mjs";
import { P as ProductCard } from "./_ssr/ProductCard-DSqOGi5a.mjs";
import "./_libs/seroval.mjs";
import { w as ChevronLeft, P as Package, H as Heart, j as ChevronRight, x as Minus, y as Plus, e as Check, a as ShoppingBag, z as Upload, r as ChevronDown, E as CircleQuestionMark, F as Ruler, G as Clipboard, R as RotateCcw } from "./_libs/lucide-react.mjs";
...
import "./_ssr/server-vV9MCtmr.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-20 items-start", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-0 lg:sticky lg:top-24 space-y-5 flex flex-col mt-5 lg:mt-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: cn("text-xl sm:text-2xl font-bold tracking-tight text-foreground", isSoldOut && "text-foreground/40 line-through"), children: [
              "₱",
      ...
      relatedProducts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 pt-16 border-t border-border/80", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-x-3 gap-y-6 sm:gap-6", children: relatedProducts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p }, p.id)) })
      ] })
    ] })
  ] });
}
